...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EsJA1sBJjw3y3FhzZpEb.AhPgjPQeExZkbn9kdJiY2W.HP+Vpe2Z7A1XDWq2GOpzF3Qf7zx7lxuEy4ilrNxjz1k=')
nadya.loginResult()
print "Nadya-Login Success\n"

ki = LINETCR.LINE()
ki.login(token='EsvkSjEehzUNE29YNbZa.WXyrvcqwVMFQWj/8yRaJ6G.uEonCkJPDkeRqiBvfAKNwFn2XrSIAMdrevPZbQ2XuXg=')
ki.loginResult()
print "ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token='EskxuMwA3g72cXHpoXdb.aW7joLPbXb5Q0cnuObxhAW.8GCJbz4HiqbtEPqvdsT8InbuwVyG9Nu1cjvJ1P0ObWQ=')
kk.loginResult()
...
╠═════════════════════════
"""
adhi="u1f40e533d1994247b5a0064d1f51c668"
...
Bots=[mid,Amid,Bmid]
Creator=["u687a46269a84797cca04df4a0e3232db","uc31611542416be67eac09fbc62b023ea","u030ec93a5a41c41e6ad02354a015c76b","u1f40e533d1994247b5a0064d1f51c668"]
admin=["u687a46269a84797cca04df4a0e3232db","uc31611542416be67eac09fbc62b023ea","u030ec93a5a41c41e6ad02354a015c76b","u1f40e533d1994247b5a0064d1f51c668"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Ghovin\nContact Me : 👉 line.me/ti/p/~ghovin87",
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
		...
		nadya.sendText(msg.to,"Itu Majikan Kami (^_^)")
              ...
              if msg.from_ in admin:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            nadya.sendText(msg.to,"Admin Ghovin Ditambahkan")
                        except:
                            pass
                print "[Command]Tambah admin executed"
              else:
              ...
              if msg.from_ in admin:
                print "[Command]Admin off Executing"
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.off(target)
                            nadya.sendText(msg.to,"Admin Ghovin Dihapus")
                        except:
                            pass
                print "[Command]Admin off executed"
              else:
                nadya.sendText(msg.to,"Command Denied.")
                nadya.sendText(msg.to,"Creator Permission Required.")
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "u1f40e533d1994247b5a0064d1f51c668"
                nadya.inviteIntoGroup(msg.to,[midd])
