...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='ErhOnjY6eJMCjYSmp7Nb.AhPgjPQeExZkbn9kdJiY2W.q69IGPgRcMitK7+oQJ3dRyHX8YjRcVJ0OVmtsIKemVI=')
nadya.loginResult()
print "Nadya-Login Success\n"

ki = LINETCR.LINE()
ki.login(token='EraQYi9IlwyyMduozdAa.WXyrvcqwVMFQWj/8yRaJ6G.BdHWCrp7ob0MX1RScJ3K+IDh3dfI0Yc1sT+idpVgIJo=')
ki.loginResult()
print "ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token='Er8dKHdD2axPGEdhjReb.aW7joLPbXb5Q0cnuObxhAW.3m/RPBJFKKYyTqLhRZMWm6WDQ/4xwKbPegeFuLGpXdk=')
kk.loginResult()
