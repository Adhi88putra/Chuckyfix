...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='ErhOnjY6eJMCjYSmp7Nb.AhPgjPQeExZkbn9kdJiY2W.q69IGPgRcMitK7+oQJ3dRyHX8YjRcVJ0OVmtsIKemVI=')
cl.loginResult()
...
km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='ErqvmkF8CQUzzhDu9nh8.h0dLm9gzqKE1Oaznh1hgAa.OarDzKJmwxR+//dxtay9A/D8SWE3QJ6ggUdrCQ1aPps=')
km.loginResult()
...
Creator=["u687a46269a84797cca04df4a0e3232db","u1f40e533d1994247b5a0064d1f51c668"]
admin=["u687a46269a84797cca04df4a0e3232db","uc31611542416be67eac09fbc62b023ea","u030ec93a5a41c41e6ad02354a015c76b"]
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : ghovin\nContact Me : 👉 line.me/ti/p/~ghovin87",
    "commentOn":True,
    "commentBlack":{},
...
#                            wait["blacklist"][op.param2] = True                            
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u687a46269a84797cca04df4a0e3232db"
                admin2 = "u030ec93a5a41c41e6ad02354a015c76b"
                admin3 = "uc31611542416be67eac09fbc62b023ea"
                msg.contentMetadata = {'mid': adhi}
                cl.sendMessage(msg)
...
#                kc.sendMessage(msg)
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "uc31611542416be67eac09fbc62b023ea"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
